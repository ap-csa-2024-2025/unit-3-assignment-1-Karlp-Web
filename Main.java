...
public class Main
{
  public static void main(String[] args)
  {
    ...
    //congruent if they either rotated, or exactly equal to each other; equals() from the rectrangle class will check
    //equality of rectangles for me
    boolean isCongruent = isRotated || r1.equals(r2);

    //similar if they are either congruent, or if the ratio of the lengths is equal to the ration of the widths
